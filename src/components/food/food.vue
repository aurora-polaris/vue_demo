    ...
    <div v-show="isShow" class="food" ref="food">
      <div class="food-content">
        ...
        <div class="rating">
          ...
          <ratingselect :onlyContent="onlyContent" :rateType="rateType"
                        :toggleOnlyContent="toggleOnlyContent" :setRateType="setRateType" :ratings="food.ratings||[]" :desc="desc"></ratingselect>
          <div class="rating-wrapper">
            <ul>
              <li class="rating-item border-1px" v-if="filterRatings" v-for="rating in filterRatings">
                <div class="user">
            ...
            <div class="no-rating" v-if="filterRatings" v-show="filterRatings.length==0">暂无评价</div>
          </div>
        </div>
